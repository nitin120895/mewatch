...
export default class H9ImageComponent extends React.Component<any, H9ImageState> {
	constructor(props) {
		...
		this.state = {
			...
			imgPos: 'fullWidth',
			imgUrl: hero3x1,
			imgUrlWidth: sass.h9ImageComponentUrlWidth,
			imgUrlHeight: sass.h9ImageComponentUrlHeight,
	...
	private onImgTypeChange = e => {
		...
		this.setState({ imgType: type, imgUrl: url, imgUrlWidth: width, imgUrlHeight: height });
	};
