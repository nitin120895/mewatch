				...
				<form className={bem.b()}>
					<fieldset>
						...
						<div className={bem.e('input-group')}>
							...
							<input type="text" className="default-input" value={fillColor} onChange={this.onFillColorChange} />
						</div>
						<div className={bem.e('input-group')}>
							<label className={bem.e('label')}>Stroke: </label>
							<input type="text" className="default-input" value={strokeColor} onChange={this.onStrokeColorChange} />
						</div>
						<div className={bem.e('input-group')}>
							<label className={bem.e('label')}>Stroke Width: </label>
							<input type="text" className="default-input" value={strokeWidth} onChange={this.onStrokeWidthChange} />
						</div>
					</fieldset>
				</form>
