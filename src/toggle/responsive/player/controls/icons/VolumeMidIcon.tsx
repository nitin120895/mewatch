...
interface VolumeMidIconProps extends React.Props<any> {
	className?: string;
}

export default class VolumeMidIcon extends React.Component<VolumeMidIconProps, any> {
	render() {
		const { className } = this.props;
		return (
			<svg className={cx('svg-icon', className)} viewBox="0 0 43 36">
