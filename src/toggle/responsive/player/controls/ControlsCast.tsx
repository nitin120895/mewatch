...
import { showCastIntro } from 'ref/responsive/player/cast/Cast';
...
class ControlsCast extends React.Component<ControlsCastProps> {
	...
	render() {
		...
		return (
			<div className={cx(className, connectionClass, bem.b())}>
				<IntlFormatter elementType="button" className={cx('cast-button')} tabIndex={-1}>
					<CastIcon />
				</IntlFormatter>
				<IntlFormatter
					elementType="button"
