...
import { resolveAlignment, resolveVerticalSpacingClassNames } from '../util/custom';
...
type Ed1PageEntryProps = TPageEntryImageProps<CustomFields>;

export default class Ed1Image extends React.Component<Ed1PageEntryProps, any> {
