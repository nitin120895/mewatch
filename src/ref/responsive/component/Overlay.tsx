...
export default class Overlay extends React.Component<OverlayProps, OverlayState> {
	...
	render() {
		const { className, groupClassName, role, opened, onDismiss } = this.props;
		...
		return (
			<div ref={this.onContainerRef} className={cx(bem.b(), className)} role={role} aria-label={this.props.ariaLabel}>
				<div
					role="button"
